...
def main() -> None:
    ...
    parser.add_argument(
        "--nnUNet_raw_data_base", type=str, help="nnUNet raw data base."
    )

    # NNUNET_PREPROCESSED argument
    parser.add_argument("--nnUNet_preprocessed", type=str, help="nnUNet preprocessed.")

    # RESULTS_FOLDER argument
    parser.add_argument("--model_folder", type=str, help="Model folder.")

    # DLICV_TASK argument
    parser.add_argument("--DLICV_task", type=int, help="DLICV task.")

    # DLMUSE_TASK argument
    parser.add_argument("--DLMUSE_task", type=int, help="DLMUSE task.")

    # DLICV_FOLD argument
    parser.add_argument("--DLICV_fold", type=int, help="DLICV fold.")

    # DLMUSE_FOLD argument
    parser.add_argument("--DLMUSE_fold", type=int, help="DLMUSE fold.")

    # ALL_IN_GPU argument
    parser.add_argument("--all_in_gpu", type=str, default="None", help="All in GPU.")
    ...
    parser.add_argument(
        "--extract_roi_masks", action="store_true", help="extract individual ROI masks"
    )
