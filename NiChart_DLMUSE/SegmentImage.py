...
def run_dlicv(in_dir: str, in_suff: Any, out_dir: str, out_suff: Any, device: str) -> None:
    # Call DLICV
    print('Running DLICV')
...
def run_dlmuse(in_dir: str, in_suff: Any, out_dir: str, out_suff: Any, device: str) -> None:
    # Call DLMUSE
